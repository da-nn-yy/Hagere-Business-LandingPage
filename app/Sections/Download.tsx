...
const DownloadStoreLinks = () => (
  <ul className="flex flex-wrap items-center gap-6">
    {links.map(({ id, url, icon, title }) => (
      <li key={id} className={TECH_LINK_WRAPPER_CLASSES}>
        <a href={url} aria-label={title} className={TECH_LINK_CLASSES}>
